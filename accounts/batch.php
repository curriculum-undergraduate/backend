        ...
        <div class="bg-gray-100 w-full h-screen px-10 py-6 flex flex-col gap-y-6 overflow-y-scroll">
            ...
            <?php if ($user->is_admin(Session::get('email'))) : ?>
                ...
                <div class="flex items-center gap-x-4 justify-between">
                    ...
                    <button type="button" data-modal-toggle="adduser-modal" id="addbatch"
                                ...
                                <?php $row = 1; ?>
                                    <?php foreach ( $batch as $_batch ) : ?>
                                        <tr>
                                            ...
                                            <?php if ($user->is_admin(Session::get('email'))) : ?>
                                                <td>
                                                    <button type="button" data-modal-toggle="update-modal" id="edit"
                                                    ...
                                                    <button type="button" data-modal-toggle="delete-modal" id="delete"
