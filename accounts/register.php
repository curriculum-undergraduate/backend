...
<body style="background-image: url('assets/img/background.jpg')" onload='hide_loading();'>
<div class="overlay">
    <div class="loading">
        <div id="loader">
            <div id="shadow"></div>
        ...
        <div class="lg:p-16 lg:flex-1">
            ...
            <form onsubmit="return false" id="register-form">
                ...
                <div class="mt-5">
                    ...
                    <!-- <div class="flex mt-3">
                        <button class="w-full px-6 py-2 mt-4 text-white bg-[#b6833b] rounded-full hover:bg-[#c5985f]" name="submit" id="btn-submit" onclick="CheckLength('InputPassword')">Create
                            Account</button>
                    </div> -->
                    <div class="flex mt-3">
                        <button class="w-full px-6 py-2 mt-4 text-white bg-[#b6833b] rounded-full hover:bg-[#c5985f]" name="submit" id="btn-submit" onclick="sukses()">Create
                            Account</button>
                    </div>
